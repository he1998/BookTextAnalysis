 ...
 * It will used to deal with text that use single quotation marks(Only alice-in-wonderland.txt will single quotation mark)
...
public class BookQuotesSQ {
	 ...
	 */
	public BookQuotesSQ(String bookName){
	...
	/**
	 * This method will extract quotes and add it into quotes
	 */
	...
	public void getTop10LongestQuotes(){
		...
		//create an array, which equals to lengthArray
		...
		//create an ArrayList<String> called top10quotes  
		ArrayList<String> top10quotes  = new ArrayList<String>();
		
		//add each quote's key into top10quotes  
		for(int r = 0; r<10; r++){
